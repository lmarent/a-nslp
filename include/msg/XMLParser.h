...
/*!  \file   XMLParser.h
    ...
    $Id: XMLParser.h 748 2015-09-10 16:38:00Z amarentes $
*/
...
class XMLParser
{
  ...
  public:
    ...
    XMLParserValidate(string dtdname, string fname, string root);

    XMLParserValidate(string dtdname, char *buf, int len, string root);
