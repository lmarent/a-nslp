...
/// The session classes.
/// ----------------------------------------------------------
/// $Id: session_id.h 2558 2015-08-31 14:02:00 amarentes $
...
//
// ===========================================================
#ifndef ANSLP_SESSION_ID_H
#define ANSLP_SESSION_ID_H
...
template <> struct hash<anslp::session_id> {
	inline size_t operator()(const anslp::session_id& id) const {
