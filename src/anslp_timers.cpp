/// ----------------------------------------*- mode: C++; -*--
/// @file anslp_timers.cpp
/// Timer-related classes.
/// ----------------------------------------------------------
/// $Id: anslp_timers.cpp 2558 2015-08-31 11:06:00 amarentes $
/// $HeadURL: https://./src/anslp_timers.cpp $
// ===========================================================
//                      
 ...
 * Constructor.
 */
timer::timer(session *s) : id(0), owning_session(s) 
{
	// nothing to do
}
