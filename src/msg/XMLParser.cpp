...
/*!  \file   XMLParser.cpp
    ...
    This file is part of IP Auction Processing protocol Application (ANSLP).
    ...
    $Id: XMLParser.cc 748 2015-09-10 16:38:00Z amarentes $
...
XMLParser::XMLParser():
fileName(""), dtdName(""), XMLDoc(NULL), ns(NULL)
{
...
XMLParser::XMLParserValidate(string dtdname, string fname, string root)
...
XMLParser::XMLParserValidate(string _dtdname, char *buf, int len, string root)
{
    dtdName = _dtdname;
