...
/// ----------------------------------------------------------
/// $Id: information_code.cpp 2558 2015-08-30 amarentes $
...
#define LogError(msg) ERRLog("infomation_code", msg)
#define LogWarn(msg) WLog("infomation_code", msg)
#define LogInfo(msg) ILog("infomation_code", msg)
#define LogDebug(msg) DLog("infomation_code", msg)
...
information_code::information_code()
		: anslp_object(OBJECT_TYPE, tr_mandatory, true),
...
information_code::information_code(uint8 severity, uint8 response_code,
		...
		: anslp_object(OBJECT_TYPE, treatment, _unique),
...
bool information_code::check_body() const 
{
	...
	LogDebug("Ending check_body" << val_return);
	return val_return;
	
}


bool information_code::equals_body(const anslp_object &obj) const {
 ...
 *
 * @return an anslp object type (16 bit)
 */
 ...
 *
 * @param obj_type an anslp object type (16 bit)
 */
