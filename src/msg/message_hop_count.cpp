...
/// ----------------------------------------------------------
/// $Id: message_hop_count.cpp 2558 2015-08-30 13:52:00 amarentes $
/// $HeadURL:  $
// ===========================================================
//                      
...
message_hop_count::message_hop_count(uint32 mhc, treatment_t treatment, bool _unique)
		: anslp_object(OBJECT_TYPE, treatment, _unique), value(mhc) {
...
bool message_hop_count::equals_body(const anslp_object &obj) const {
