...
/// ----------------------------------------------------------
/// $Id: msg_sequence_number.cpp 2558 2015-08-30 15:25:00Z amarentes $
/// $HeadURL:  $
// ===========================================================
//                      
...
msg_sequence_number::msg_sequence_number()
		: anslp_object(OBJECT_TYPE, tr_mandatory, true), value(0) 
{
...
msg_sequence_number::msg_sequence_number(uint32 msn, treatment_t treatment, bool _unique)
		: anslp_object(OBJECT_TYPE, treatment, _unique), value(msn) 
{
...
bool msg_sequence_number::equals_body(const anslp_object &obj) const 
{
