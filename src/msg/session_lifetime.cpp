...
/// ----------------------------------------------------------
/// $Id: session_lifetime.cpp 2558 2015-08-30 amarentes $
...
session_lifetime::session_lifetime()
		: anslp_object(OBJECT_TYPE, tr_mandatory, true), slt(0) 
{
...
session_lifetime::session_lifetime(uint32 _slt, treatment_t treatment, bool _unique)
		: anslp_object(OBJECT_TYPE, treatment, _unique), slt(_slt) 
{
...
bool session_lifetime::equals_body(const anslp_object &obj) const 
{
