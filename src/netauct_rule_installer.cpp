...
/// ----------------------------------------------------------
/// $Id: nop_policy_rule_installer.cpp 2558 2015-09-03 08:23:00 amarentes $
...
auction_rule * 
netauct_rule_installer::install(const auction_rule *rule) 
{
...
auction_rule * netauct_rule_installer::remove(const auction_rule *rule) 
{
