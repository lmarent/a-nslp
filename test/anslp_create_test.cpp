/*
 * Test the anslp_create class.
 *
 * $Id: anslp_create.cpp 1730 2015-09-03 21:30:00  $
 * $HeadURL: https://./test/anslp_create.cpp $
 */
...
class AnslpCreateTest : public CppUnit::TestCase 
{

	CPPUNIT_TEST_SUITE( AnslpCreateTest );
...
CPPUNIT_TEST_SUITE_REGISTRATION( AnslpCreateTest );

void AnslpCreateTest::add_fields(anslp_ipap_message * mess) 
{
...
void AnslpCreateTest::testBasics() 
{
	anslp_create c1;
	...
	c1.set_selection_auctioning_entities(selection_auctioning_entities::sme_all);
	CPPUNIT_ASSERT( c1.get_selection_auctioning_entities() == selection_auctioning_entities::sme_all );
...
void AnslpCreateTest::testComparison() 
{
	anslp_create *c1 = new anslp_create();
	anslp_create *c2 = new anslp_create();
...
void AnslpCreateTest::testCopying() 
{
	anslp_create *c1 = new anslp_create();
...
void AnslpCreateTest::testManager01() 
{
	...
	m1->set_selection_auctioning_entities(selection_auctioning_entities::sme_all);
...
void AnslpCreateTest::testManager02() 
{
